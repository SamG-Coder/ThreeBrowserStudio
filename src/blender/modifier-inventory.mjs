...
const modifierRows = [
  ...
  ['SOLIDIFY', 'SolidifyModifier', 'generate', 'Solidify', 'Give a surface thickness.', 'live-geometry', 'Studio evaluates bounded thickness and offset on indexed and manifold editable meshes. Editable shells preserve corner layers and materials, close boundary rims, and retain sharp/crease edges; vertex-group and even-thickness controls require baking.'],
  ['SUBSURF', 'SubsurfModifier', 'generate', 'Subdivision Surface', 'Subdivide faces for a denser, smoother surface.', 'live-geometry', 'Studio evaluates one to six bounded simple or Loop triangle subdivision levels. Editable topology preserves corner layers/material seams and consumes sharp edges plus persistent normalized edge crease weights before render seam expansion. Catmull-Clark and topology changes after render seam modifiers require a different evaluator or reordering.'],
