...
const entries = [
  ...
  capability({
    ...
    supportedSubset: ['local translation', 'Euler rotation', 'scale', 'uniform guarded delta transforms', 'parent transforms', 'world-preserving group and ungroup', 'exact numeric layout'],
    unsupportedSubset: ['quaternions', 'per-object heterogeneous bulk transforms', 'parent inverse document field', 'apply/freeze transforms', 'transform orientations', 'snapping and proportional editing', 'TRS representation of shear'],
