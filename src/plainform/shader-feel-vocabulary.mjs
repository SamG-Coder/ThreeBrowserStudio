const FEELS = Object.freeze([
  ...
  { terms: ['automotive clear coat', 'automotive paint', 'car paint'], inputs: { roughness: 0.16, coatWeight: 0.92, coatRoughness: 0.035, specularIorLevel: 0.5 } },
  { terms: ['orange peel', 'orange-peel'], inputs: { roughness: 0.22, coatWeight: 0.88, coatRoughness: 0.085 } },
  ...
  { terms: ['carbon fibre', 'carbon fiber', 'satin carbon'], inputs: { metallic: 0.12, roughness: 0.3, coatWeight: 0.38, coatRoughness: 0.16 }, color: '#15181a' },
  { terms: ['tyre rubber', 'tire rubber', 'rubber'], inputs: { metallic: 0, roughness: 0.78, coatWeight: 0.04 }, color: '#171717' },
  { terms: ['black honeycomb', 'honeycomb'], inputs: { metallic: 0.05, roughness: 0.64 }, color: '#101214' },
  ...
  { terms: ['smoked automotive glass', 'smoked glass', 'tinted glass'], inputs: { roughness: 0.1, transmissionWeight: 0.82, ior: 1.48, alpha: 0.34, coatWeight: 0.2 }, color: '#26373a' },
