...
const shaderNodes = [
  ...
  node('texture.sample2d', 'Sample Texture', 'texture', { cost: 8, stages: ['vertex', 'fragment'], inputs: [['uv', port('vec2', { required: true })]], outputs: [['color', port('color')], ['alpha', port('float')]], params: [['textureId', param('stableId', { required: true })], ['colorSpace', param('enum', { values: ['srgb', 'none'], required: true })]], tags: ['sampler'] }),
...
const blueprintNodes = [
  ...
  node('animation.play', 'Play Animation', 'animation', { inputs: [execIn, entityIn], outputs: [execOut, ['complete', port('exec')]], params: [['clipId', param('stableId', { required: true })], ['loop', param('boolean', { default: false })], ['speed', param('number', { default: 1, min: -16, max: 16 })]] }),
