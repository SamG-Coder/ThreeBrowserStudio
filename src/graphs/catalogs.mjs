...
const blueprintNodes = [
  ...
  node('physics.addForce', 'Add Force', 'physics', { inputs: [execIn, entityIn, ['force', port('vec3', { required: true })]], outputs: [execOut] }),
  node('physics.addImpulse', 'Add Impulse', 'physics', { inputs: [execIn, entityIn, ['impulse', port('vec3', { required: true })]], outputs: [execOut] }),
  ...
  node('camera.followEntity', 'Follow Entity', 'camera', { inputs: [execIn, ['camera', port('entityId', { required: true })], ['target', port('entityId', { required: true })], ['offset', port('vec3')], ['smoothing', port('float')]], outputs: [execOut] }),
