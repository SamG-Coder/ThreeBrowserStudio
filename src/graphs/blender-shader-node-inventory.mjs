...
const LIVE_TSL_IDS = new Set([
  ...
  'ShaderNodeTangent', 'ShaderNodeTexCoord', 'ShaderNodeUVMap',
  ...
  'ShaderNodeTexWave', 'ShaderNodeTexChecker', 'ShaderNodeTexGradient', 'ShaderNodeTexImage',
  'ShaderNodeTexWhiteNoise', 'ShaderNodeTexMagic', 'ShaderNodeTexBrick',
  'ShaderNodeCombineXYZ', 'ShaderNodeSeparateXYZ',
  'ShaderNodeMapping', 'ShaderNodeRadialTiling', 'ShaderNodeVectorMath', 'ShaderNodeClamp',
